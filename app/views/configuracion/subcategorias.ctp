...
<div class="row">
	<div class="span1">
		<div class="button_window">
			<form action="<?php echo $this->Html->url(array('controller'=>'configuracion','action'=>'subcategoria_add'));?>">
				...
				<table id="datatable" class="table table-striped table-bordered bootstrap-datatable dataTable" cellspacing="0" cellpadding="0" border="0" aria-describedby="datatable_info">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $categoria['Subcategoria']['id']; ?></td>
							<td><?php echo $categoria['Subcategoria']['nombre_subcategoria']; ?></td>
							<td><?php echo $categoria['Categoria']['nombre_cat']; ?></td>
							<td><?php echo $categoria['Subcategoria']['descripcion']; ?></td>
						</tr>
						<?php endforeach; ?>
					</tbody>
				</table>
