...
<div class="row">
	...
	<div class="span1" id="window">
		<div class="button_window">
			<form action="<?php echo $this->Html->url(array('controller'=>'adquisiciones','action'=>'tesis_index'));?>">
...
<div class="row-fluid">
	<div id="col0" class="span12 column ui-sortable">
		<div class="box">
			<h4 class="box-header round-top">Agregar Tesis</h4>
			<div class="box-container-toggle">
				<div class="box-content">
					<?php echo $this->Form->create('Texto',array('url'=>'/adquisiciones/tesis_add','class'=>'form-horizontal','type'=>'file','name'=>'form1'));?>
