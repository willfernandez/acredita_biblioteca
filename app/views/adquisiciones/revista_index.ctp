...
<div class="row">
	...
	<div class="span1" id="window">
		<div class="button_window">
			<?php //echo $this->Form->create('Ejemplare',array('url'=>'/adquisiones/ejemplar_add/'.$''));?>
			<form method="post" class="FormularioEnviar" action="<?php echo $this->Html->url(array('controller'=>'adquisiciones','action'=>'ejemplar_add'));?>"> 
				<input type="hidden" name="TextoIdValue" id="TextoIdEjemplar" />
...
<div class="row-fluid">
	<div class="span12">
		<div class="box">
			<h4 class="box-header round-top">Material Bibliográfico: Revistas</h4>
