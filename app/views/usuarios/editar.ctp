		...
		<div class="box">
			...
			<div class="box-container-toggle">
				<div class="box-content">
					<?php echo $this->Form->create('Usuario',array('action'=>'editar','class'=>'form-horizontal'));?>
					<?php
						...
						echo $this->Form->input('password',array('label'=>'Contraseña','value'=>'','class'=>':required','div'=>'control-group','between'=>'<div class="controls">','after'=>'</div>'));	
