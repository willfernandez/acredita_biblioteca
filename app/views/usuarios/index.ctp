...
<div class="row">
	<div class="span1">
		<div class="button_window">
			<form action="<?php echo $this->Html->url(array('controller'=>'usuarios','action'=>'agregar'));?>">
...
<div class="row-fluid">
	<div class="span12">
		<div class="box">
			<h4 class="box-header round-top">Usuarios</h4>
			<div class="box-content">
				<table id="datatable" class="table table-striped table-bordered bootstrap-datatable dataTable" cellspacing="0" cellpadding="0" border="0" aria-describedby="datatable_info">
					<thead>
						...
						<tr>
							<td style="text-align:center"><input type="checkbox" name="UsuarioId[]" value="<?php echo $usuario['Usuario']['id']; ?>"/></td>
